...
static Key keys[] = {
	...
	{ MODKEY,			XK_v,		spawn,		SHCMD("CM_OUTPUT_CLIP=1 clipmenu") },
	{ MODKEY|ShiftMask,		XK_v,		spawn,		SHCMD("CM_OUTPUT_CLIP=NULL clipmenu") },
...
#endif
	{ ClkStatusText,        MODKEY,		Button1,        spawn,          SHCMD(TERMINAL " -e vim ~/.local/src/dwm/config.h") },
